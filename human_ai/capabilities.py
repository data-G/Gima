...
CAPABILITY_SPECS: List[CapabilitySpec] = [
    ...
    CapabilitySpec(
        ...
        "Research brain profile exists; generator adapter not yet configured.",
        "Connect approved local/API video generator and consent/provenance logging.",
        "https://deepmind.google/technologies/veo/",
        _planned,
    ),
    CapabilitySpec(
    ...
    CapabilitySpec(
        ...
        "Self-update prepare/ready/sync workflow, backups, tests, GitHub push.",
        "Add patch review scoring and automatic rollback tests.",
        "https://www.anthropic.com/news/claude-4",
        _always_started,
    ),
    CapabilitySpec(
